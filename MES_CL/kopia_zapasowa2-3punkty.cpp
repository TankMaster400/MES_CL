...
//        Surp[1][1][1] = 0;
//        Surp[1][2][0] = 1.;
//        Surp[1][2][1] = sqrt(15.0) / 5.0;
//
//        Surp[2][0][0] = sqrt(15.0) / 5.0;
//        Surp[2][0][1] = 1.;
//        Surp[2][1][0] = 0;
//        Surp[2][1][1] = 1.;
//        Surp[2][2][0] = -sqrt(15.0) / 5.0;
//        Surp[2][2][1] = 1.;
//
//        Surp[3][0][0] = -1.;
...
//        }
//
//        int w1 = 0, w2 = 0, moment = 0;
//        for (int c = 0; c < N; c++)
//        {
//            moment++;
//            if (moment > sqrt(N)) { w1 = 0; moment = 0; }
//
//            for (int j = 0; j < 4; j++)
//            {
//                for (int g = 0; g < 4; g++)
...
//            for (int g = 0; g < 4; g++)
//            {
//                cout << grid1.Tele[i].H[j][g] << endl;
//
//                cout << agr_tab[grid1.Tele[i].ID[j] - 1][grid1.Tele[i].ID[g] - 1] << endl;
